...
**References used:**
- [text](https://registry.terraform.io/providers/hashicorp/google/latest)
- [text](https://registry.terraform.io/providers/hashicorp/local/latest)
...
**References used:**
- [text](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/compute_network)
- [text](https://github.com/BalericaAI/SEIR-1/blob/main/weekly_lessons/weekb/terraform/2-vpc.tf)
...
**References used:**
- [text](https://github.com/BalericaAI/SEIR-1/blob/main/weekly_lessons/weekb/terraform/8-outputs.tf)
...
**References used:**
- [text](https://www.udemy.com/course/terraform-for-beginners-using-google-cloud/learn/lecture/28569409#overview) 
