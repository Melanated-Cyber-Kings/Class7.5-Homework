...
resource "google_compute_instance_template" "mephisto_template" {
  ...
  network_interface {
    ...
    # This allows instance to be deployed in public subnet.
    # subnetwork = google_compute_subnetwork.mephisto.self_link

    # This allows instance to be deployed in private subnet.
    subnetwork = google_compute_subnetwork.mephisto_private.self_link
